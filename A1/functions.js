...
3. el jugador en turno selecciona una casilla
4.  validar si hay algun ganador
    si hay algun ganador, el juego termina
    si no hay algun ganador, cambiar el turno al jugador. regresariamos al punto 3
